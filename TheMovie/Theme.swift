...
////  Boatlah
////
////  Created by Rafat Touqir Rafsun on 5/2/16.
...
struct Theme{
    ...
    static func defaultThemes(){
        self.defaultNavBarThemes()
//        self.defaultTableViewThemes()
    }
...
//        UINavigationBar.appearance().shadowImage = UIImage()
    ...
    private static func defaultTableViewThemes(){
        ...
        let tableViewAppearance = UITableViewCell.appearance()
        tableViewAppearance.selectionStyle = UITableViewCellSelectionStyle.None
        
        let backGroundViewAsHighlightedWithColor = UIView()
        backGroundViewAsHighlightedWithColor.backgroundColor = Colors.colorLightGreen
        tableViewAppearance.selectedBackgroundView = backGroundViewAsHighlightedWithColor
//        UITableViewCellSelectionStyleGray
    }
    
    internal static func customNavigationBackBarButton(withImage image:UIImage?,withTitle title:String = "",toViewController viewController:UIViewController?){
        ...
        viewController?.navigationItem.backBarButtonItem = UIBarButtonItem(title: title, style: UIBarButtonItemStyle.Plain, target: nil, action: nil)
