...
//        cancelAllRequests()
        ...
        let afMethod = Alamofire.Method.GET
        var afParameters = params
        
        //additional param
        afParameters?["api_key"] = Urls.API_KEY
...
//        }
        ...
        Alamofire.request(afMethod, url, parameters: afParameters)
